...
import AffiliateHeroSection from "@/components/affiliate/hero/heroSection";
import AffiliatePositionsList from "@/components/affiliate/position/position";
...
const AffiliatePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <AffiliateHeroSection onSearch={handleSearch} />

      <AffiliatePositionsList
