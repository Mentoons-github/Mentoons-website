        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {issues.map((issue, ind) => (
            ...
            >
              ...
              <p className="text-lg font-medium text-gray-600">{issue.text}</p>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="relative grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-xl text-gray-700 leading-relaxed max-w-xl">
              Begin your journey with us today and unlock the true potential of
              your child.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex gap-5 bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition">
                ...
                <p className="text-gray-600 text-lg">
                  As parents ourselves, we understand the challenges you face in
                  today's digital age. We have experienced the same struggles
                  and have successfully guidede numerous families towards a
              ...
              <div className="flex gap-4 bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition">
                ...
                <p className="text-gray-600 text-lg">
                  You can trust us to provede the guidance and support you need
                  to overcome thesse challenges
                </p>
              </div>
              ...
              <div className="flex gap-4 bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition">
                ...
                <p className="text-gray-600 text-lg">
                  Our team & psychologists are dedicated to helping you and your
                  child succeed.
                </p>
              </div>
            </div>
