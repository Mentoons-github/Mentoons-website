      ...
      {showPopup && (
        <div className="w-screen h-screen bg-black/60 fixed top-0 left-0 flex items-center justify-center z-[999999] ">
          <motion.div
            ...
            style={{
              boxShadow:
                "2px 3px 4px 0px #90E1FF4A inset, -3px -3px 6px 0px #046D949E inset",
            }}
          >
            ...
            <div className="space-y-6 flex flex-col items-center justify-center">
              ...
              <div className="bg-white rounded-xl p-5 flex flex-col items-center justify-center relative">
                ...
                <p className="text-lg text-center">
                  You've successfully joined, check
                  <br /> your email for a welcome Gift!
                </p>
              </div>
              <button
                ...
                style={{
                  boxShadow:
                    "2px 2px 6.3px 0px #B8FFAA82 inset, -2px -2px 4px 0px #11660099 inset",
                }}
                onClick={() => sendComic()}
              >
                Claim your Comic
