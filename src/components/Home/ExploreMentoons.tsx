  ...
  const cardsData: CardData[] = [
    {
      ...
      description:
        "Dive into colorful worlds and exciting stories that teach valuable lessons while entertaining young readers. Our diverse range of comics covers various subjects, from history and science to social skills and personal growth.",
    ...
    },
    {
      ...
      description:
        "Experience the magic of storytelling like never before! Our audio comics bring illustrations to life with professional voice acting, sound effects, and music, creating an immersive experience that enhances listening skills and imagination.",
    ...
    },
    {
      ...
      description:
        "Tune in to our educational and entertaining podcasts designed specifically for young listeners. From fascinating facts to thought-provoking discussions, our podcasts make learning fun and accessible.",
    ...
    },
    {
      ...
      title: "Workshops",
      description:
        "Join our interactive workshops led by industry professionals and educators. We offer both in-person and virtual sessions that encourage creativity, teamwork, and skill development in areas such as comic creation, storytelling, and character design.",
          ...
          <Fade key={index} duration={400} delay={index * 100} direction="up">
            <div className="flex flex-col items-center text-center">
              ...
              <div className="flex flex-col justify-center p-4">
                <h3 className="text-4xl font-semibold text-white mb-4 font-montserrat">
                  {item.title}
                </h3>
