      ...
      <div className="flex flex-col lg:flex-row lg:gap-10 items-center lg:items-start">
        <div className="w-full lg:w-1/3 flex flex-col mb-16 relative">
          <img
            src="/clouds.png"
            alt="clouds asset"
            className="absolute top-0 left-[7rem] h-[80%] w-full object-contain"
          />
        ...
        <div className="w-full lg:w-2/3 flex flex-col items-center px-10">
          <Fade direction="up" triggerOnce>
            <h1 className="text-5xl font-semibold mb-6 text-center lg:text-left">
              Why Choose Mentoons?
            </h1>
          </Fade>
          ...
          <Fade delay={100} direction="up" triggerOnce>
            <ul className="text-left lg:text-pretty text-2xl list-disc font-montserrat">
              <li className="mb-2">
                <b>Unique Approach:</b> Combines mentoring with cartoons, making
                learning fun and engaging.
              </li>
              <li className="mb-2">
                <b>Proven Methods:</b> Uses evidence-based methodologies to
                ensure effectiveness.
              </li>
              <li className="mb-2">
                <b>Holistic Coverage:</b> Addresses a wide range of issues, from
                screen time reduction to building social skills.
              </li>
              <li className="mb-2">
                <b>Expert Team:</b> Diverse professionals including developers,
                illustrators, designers, writers, music producers, and
                psychologists.
              </li>
            </ul>
          </Fade>
