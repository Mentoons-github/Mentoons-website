...
const AddaSection = () => {
  ...
  return (
    <motion.section
      ...
      className="flex items-center justify-start gap-8 p-10 py-10 bg-transparent sm:py-10 md:py-15 xl:py-23 sm:p-8 md:p-10 lg:p-15 xl:p-20"
    >
      <div className="flex flex-col items-start justify-start gap-4 sm:gap-2">
        ...
        <div className="flex items-center justify-center block pt-10 md:hidden">
          <AddaTV />
        </div>
              ...
              >
                <ul className="flex flex-col w-full h-full gap-2">
                  {FAQ.map((faq, index) => (
                    <li
                      key={index}
                      className="p-2 border rounded cursor-pointer sm:p-4"
                    >
                      <div
      ...
      <motion.div
        ...
        transition={{ duration: 1, ease: "easeOut", delay: 1 }}
        className="grid hidden p-2 place-items-center flex-0 xl:flex-1 md:block"
      >
        <AddaTV />
        <a
          ...
          className="flex items-center gap-2 px-4 py-2 mt-4 text-white transition bg-red-600 rounded-lg shadow-lg hover:bg-red-700"
        >
