    ...
    <div className="w-full h-[85vh] lg:h-[97vh] relative overflow-hidden">
      ...
      >
        ...
        <figure className="relative w-[90vw] sm:w-[70vw] md:w-[40vw] lg:w-[30vw]">
          ...
          <img
            src="/assets/LandingPage/mentoring.png"
            alt="hero-text"
            className="w-full h-full object-contain"
          />
        </figure>
      ...
      >
        <img
          src="/assets/LandingPage/bg-bot.png"
          alt="hero-bg"
      ...
      <motion.h1 className="absolute bottom-[1vh] lg:bottom-[2vh] left-1/2 -translate-x-1/2 text-[2vw] md:text-[1.5vw] lg:text-[2.8vw] text-white font-semibold text-center animate-in ease-in  ">
