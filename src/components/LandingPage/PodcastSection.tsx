...
export const PODCAST_DATA = [
  ...
  },
  {
    ...
    description: "",
    videoSrc: `${import.meta.env.VITE_STATIC_URL}static/Parents Want To Buy Peace_01 (Mentoons).mp4`,
    category: "6-12",
  },
  {
    title: "How To Use Gadgets Effectively",
    description: "",
    videoSrc: `${import.meta.env.VITE_STATIC_URL}static/How to Use Gadgets Effectively (6 - 12)_02.mp4`,
    category: "6-12",
  },
  {
    title: "How to build Confidence",
    description: "",
    videoSrc: `${import.meta.env.VITE_STATIC_URL}static/How to Build Confidence (6-12).mp4`,
    category: "6-12",
  },
  {
    title: "Performance Addiction",
    description: "",
    videoSrc: `${import.meta.env.VITE_STATIC_URL}static/Performance Addiction (6 - 12)(1).mp4`,
    category: "6-12",
  },
  {
  ...
  },
  {
    ...
    description: "",
    videoSrc: `${import.meta.env.VITE_STATIC_URL}static/A Day With and Without a Phone (6-12)(1).mp4`,
    category: "6-12",
  },
    ...
    >
      ...
      <div className="w-full flex flex-col lg:flex-row justify-center items-center pt-20">
        <div className="w-full lg:w-1/2 px-4 lg:px-0 mb-8 lg:mb-0">
          <h1 className="text-white text-center text-lg md:text-4xl lg:text-3xl">
            Children's podcasts are audio shows that
            <br /> entertain and educate young listeners through
            <br /> stories and fun learning. They spark
            <br /> imagination and curiosity.
          </h1>
        </div>
        <div className="w-full lg:w-1/2 flex justify-center relative">
          <img
            src="/assets/LandingPage/podcast img.png"
            alt="toonla"
            className="w-[60%] h-auto object-contain relative z-10"
          />
          <img
            src="/assets/LandingPage/headphone.png"
            alt="clouds"
            className="absolute bottom-0 left-[25%] w-[8rem] md:w-[12rem] lg:w-[16rem] h-auto object-bottom z-[20]"
          />
          <h1
            className="absolute top-[60%] left-[50%] text-white text-lg md:text-4xl lg:text-3xl z-20"
            style={{
          ...
          <p className="absolute top-[70%] left-[50%] text-black font-semibold text-sm md:text-xl z-20">
            narrated by
            <br />
            psycologist
          </p>
        ...
        <div className="w-full lg:w-1/2">
          <div className="flex justify-center items-center gap-4 mb-10 px-6">
            {PodcastCategories.map((category) => (
              <div key={category}>
                <button
                  className={`px-6 py-3 rounded-full transition-colors whitespace-nowrap duration-200 text-sm lg:text-base ${
          ...
          <div
            className="lg:w-[60%] mx-auto flex flex-col gap-4 items-left h-[400px] overflow-y-auto 
          ...
          >
            {filteredPodcasts.map((podcast) => (
              <div
                key={podcast.title}
                className={`flex items-center gap-4 cursor-pointer p-2 rounded-md w-full ${
                  selectedPodcast?.title === podcast.title
                    ? "bg-white/20"
                    : "hover:bg-white/10"
                }`}
