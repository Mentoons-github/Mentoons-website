...
const ComicSection = () => {
    ...
    return (
        <div
            ...
            style={{ background: "linear-gradient(177.47deg, #FAFDEE 93.25%, #8CB301 108.11%)" }}
        >
            {/* Cloud Animation */}
            <motion.img
            ...
            >
                <figure className="max-w-fit relative left-[8%]">
                    <img src="/assets/LandingPage/comic-bnr.png" alt="comic" className="w-full h-full object-contain" />
