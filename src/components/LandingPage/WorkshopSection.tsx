...
const WorkshopSection = () => {
    ...
    return (
        <div
            ...
            style={{ background: "linear-gradient(180deg, #A4CC13 12.08%, #FFEE67 100%)" }}
        >
            <motion.img
            ...
            <div className="flex flex-col lg:flex-row justify-center items-center w-full px-4 md:px-6 lg:px-8 mx-auto py-8 lg:py-16">
                ...
                >
                    ...
                    <figure className="w-full max-w-[40rem] mx-auto relative z-40">
                        ...
                        {/* Workshop Pins */}
                        {[
                            { label:"6-12",img: "6", position: "top-[10%] left-[20%]", workshop: "6-12" },
                            { label:"13-19",img: "13", position: "top-[10%] right-[20%]", workshop: "13-19" },
                            { label:"20+",img: "20", position: "bottom-[15%] left-[20%]", workshop: "20+" },
                            { label:"Parents",img: "parents", position: "bottom-[15%] right-[20%]", workshop: "parents" },
                        ].map((pin, index) => (
                            <motion.figure
                                key={index}
                            ...
                            >
                                <div className="relative">
                                    <img
                                        ...
                                        onClick={() => navigate(`/mentoons-workshops?workshop=${pin.workshop}`)}
                                    />
