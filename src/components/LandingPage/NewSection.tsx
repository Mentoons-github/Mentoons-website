...
const NewSection = () => {
  ...
  return (
    ...
    >
      <img
        src="/assets/NewSection/Ellipse-blue.png"
        alt="New Section Background"
        className="absolute right-0 top-0 hidden lg:block"
      />
      <img
        src="/assets/NewSection/Ellipse-green.png"
        alt="New Section Background 2"
      ...
      <div className="flex flex-col lg:flex-row gap-6 max-w-7xl mx-auto ">
        ...
        <div className="flex-1 space-y-10">
          ...
          >
            ...
            >
              ...
              <div className="bg-white p-2 rounded-lg w-1/2 mr-4">
                <img
                  src="/assets/NewSection/fam-big.png"
            ...
            >
              ...
              <div className="grid grid-cols-4 gap-2">
                ...
                <div
                  ...
                  onClick={() => navigate(`/mentoons-workshops?workshop=20%2B`)}
                >
                  20 +
                </div>
                <div
          ...
          >
            ...
            >
              <img
                src="/assets/NewSection/new pod.png"
                alt="Podcast"
            ...
            <motion.div
              className="bg-pink-200 p-6 rounded-lg relative "
              variants={itemVariants}
              whileHover={{ scale: 1.02 }}
            >
        ...
        >
          ...
          <motion.div
            className="mt-6 overflow-y-scroll h-32  px-2 "
            variants={containerVariants}
            viewport={{ once: true }}
          >
