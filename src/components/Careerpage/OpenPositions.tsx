            ...
            <div className="flex flex-col lg:flex-row gap-10 py-10 lg:py-0">
                ...
                >
                    <div className="space-y-6">
                        ...
                        >
                            Join us! Whether you're experienced or just starting, bring your passion and make an impact.
                        </motion.p>
                ...
                >
                    <div className="relative">
                        ...
                        <figure className="relative w-full h-full rounded-2xl overflow-hidden">
                            <img src="/assets/images/team-Illustration.png" alt="team-illustration" className="w-full h-full object-cover" />
                        </figure>
                    </div>
                </motion.div>
            </div>
