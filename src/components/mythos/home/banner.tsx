...
const MythosBanner = () => {
  return (
    <section className="relative w-full h-screen flex justify-center items-center py-6 sm:py-8 md:py-10 bg-[#1A1D3B] mulish px-4 sm:px-8 md:px-12 lg:px-20 overflow-hidden">
      ...
      >
        <source src="/assets/mythos/banner/Planets 2_1.mp4" type="video/mp4" />
      ...
      <div className="relative space-y-3 sm:space-y-4 md:space-y-5 p-3 sm:p-4 md:p-5 text-center flex flex-col justify-center items-center w-full">
        <motion.h1
          ...
          className="text-[#E39712] font-semibold text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[54px] tracking-[1.5px] sm:tracking-[1.9px] font-montserrat px-2"
        >
        ...
        <motion.p
          ...
          className="font-semibold text-base sm:text-lg md:text-xl lg:text-2xl w-full sm:w-4/5 md:w-3/4 lg:w-3/5 xl:w-[45%] text-white font-mulish"
        >
