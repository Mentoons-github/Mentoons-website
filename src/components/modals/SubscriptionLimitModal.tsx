        ...
        >
          ...
          >
            <div className="relative bg-white rounded-3xl shadow-2xl overflow-hidden">
              ...
              <button
                onClick={onClose}
                className="absolute z-10 p-2 transition-all duration-300 rounded-full top-4 right-4 text-gray-500 hover:text-gray-700 hover:bg-gray-100 hover:scale-110"
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                  {Object.entries(plans).map(([key, plan], index) => (
                    <motion.div
                      ...
                      onClick={() =>
                        setSelectedPlan(key as "prime" | "platinum")
                      }
