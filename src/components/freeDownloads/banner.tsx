const FreeBanner = () => {
  return (
    <div className="relative min-h-[50vh] bg-gradient-to-br from-orange-400 via-yellow-300 to-orange-500 p-6 md:p-10 rounded-3xl overflow-hidden">
      <svg
      ...
      <div className="relative z-10 ml-6 md:ml-12 font-montserrat space-y-6">
        <h1 className="text-5xl md:text-7xl font-bold tracking-wider text-gray-900 drop-shadow-lg w-48 md:w-64">
          FREE DOWNLOADS
        </h1>
        <p className="max-w-md md:max-w-xl text-gray-900 text-base md:text-lg leading-relaxed">
