...
const ColorTubeStartScreen = ({ onStart }: { onStart: () => void }) => {
  return (
    <div
    ...
    >
      ...
      {/* Game Title Image */}
      <motion.img
        src="/assets/games/ColorTube/startText2.png "
        alt="Game Title"
        className="w-[600px] max-w-full z-10"
...
export default ColorTubeStartScreen;
