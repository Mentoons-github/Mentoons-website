...
const InstrumentsDifficulty = ({
  setDifficulty,
}: InstrumentsDifficultyProps) => {
  return (
    <div className="bg-gradient-to-br from-[#3e1717] to-[#5b5f49] border-2 border-[#f7e991] p-2 md:p-10 rounded-lg backdrop-blur-xl">
      <h2 className="text-xl font-bold text-[#376e5f] mb-2 text-center">
      ...
      <div className="grid grid-cols-3 gap-2 md:gap-6">
        ...
        >
          ...
          <p className="text-green-200 text-md font-medium mt-1">Ages: 6-12</p>
        </button>
        <button
        ...
        >
          ...
          <h3 className="text-lg font-bold text-white"></h3>
          <p className="text-red-200 text-md font-medium mt-1">Ages: Adults</p>
        </button>
      </div>
    </div>
  );
...
export default InstrumentsDifficulty;
