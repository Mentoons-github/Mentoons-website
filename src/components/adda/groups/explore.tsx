...
const Explore = () => {
  const exploreGroups = [
    {
      img: "/assets/adda/groups/explore/age 2-5.png",
      mainTitle: "Ages 2 - 5",
      description:
    ...
    {
      img: "/assets/adda/groups/explore/age 6-12.png",
      mainTitle: "Ages 6 - 12",
      description:
