const PatternRaceLobby = ({
  showDifficultyModal,
}: {
  showDifficultyModal: () => void;
}) => {
  return (
    <div className="h-screen bg-[url('/assets/games/patternRace/bg.jpg')] bg-cover bg-center flex flex-col items-center justify-center gap-4 sm:gap-8 p-4">
      <img
        src="/assets/games/patternRace/title.png"
        alt="title"
...
export default PatternRaceLobby;
