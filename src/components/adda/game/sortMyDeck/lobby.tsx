const SortMyDeckLobby = ({
  showDifficultyModal,
}: {
  showDifficultyModal: () => void;
}) => {
  return (
    <div className="h-screen bg-[url('/assets/games/sortMyDeck/bg.png')] bg-cover bg-center flex flex-col items-center justify-center gap-4 sm:gap-8 p-4">
      <img
        src="/assets/games/sortMyDeck/title.png"
        alt="title"
...
export default SortMyDeckLobby;
