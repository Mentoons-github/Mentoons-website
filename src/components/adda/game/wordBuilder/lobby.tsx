const WordBuilderLobby = ({
  showDifficultyModal,
}: {
  showDifficultyModal: () => void;
}) => {
  return (
    <div className="h-screen bg-[url('/assets/games/wordBuilder/bg.png')] bg-cover bg-center flex flex-col items-center justify-center gap-4 sm:gap-8 p-4">
      <img
        src="/assets/games/wordBuilder/title.png"
        alt="title"
...
export default WordBuilderLobby;
