    ...
    <section className="py-10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <p className="text-lg">
            Welcome to the FAQ section of Mentoons, where we've gathered some of
            the most asked questions to help you our services and their value.
            If you have other questions that aren't addressed here, please feel
            free to reach out!
          </p>
