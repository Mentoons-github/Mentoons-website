...
import Discover from "@/components/mythos/home/learnMore";
...
const HelperList = ({ data, label }: { data: object; label: string }) => {
  ...
  return (
    <section
      ref={ref}
      className="relative flex flex-col justify-start items-start gap-2 md:gap-5 px-5 sm:px-10 md:px-20 py-20 w-full bg-[#1A1D3B] bg-[url('/assets/mythos/background/section/stars_background.png')] bg-center overflow-hidden"
    >
      {label === "HOW WE HELP YOU" ? (
        ...
        >
          <img
            src="/assets/mythos/background/Frame.png"
            alt="mars-image"
        ...
        >
          <img
            src="/assets/mythos/planets/mars.png"
            alt="mars-image"
